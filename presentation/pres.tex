...
\begin{document}
  ...
  \begin{frame}{Ingress, results, data not touched}
    \centering\resizebox{!}{.95\textheight}{\includegraphics{results_rx.pdf}}
  \end{frame}
  ...
  \begin{frame}{Egress, results, data not touched}
    \centering\resizebox{!}{.95\textheight}{\includegraphics{results_tx.pdf}}
  \end{frame}
  ...
  \begin{frame}{Busy poll() vs run-to-completion, results}
    \centering\resizebox{!}{.95\textheight}{\includegraphics{results_poll.pdf}}
  \end{frame}
  ...
  \begin{frame}{Comparison with DPDK, results}
    \centering\resizebox{!}{.95\textheight}{\includegraphics{results_dpdk.pdf}}
  \end{frame}
